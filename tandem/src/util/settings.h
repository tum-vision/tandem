...
extern bool setting_render_displayDenseDepth;
extern bool setting_render_displaySparseDepth;
...
extern std::string depth_save_folder;
extern std::string depth_var_save_folder;
extern bool debugSaveDepthImages;
extern float save_depth_scale;

extern std::string mvsnet_folder;
extern bool mvsnet_flag;
extern float mvsnet_discard_percentage;
extern bool setting_tsdf_fusion;

extern bool setting_use_bilateral_filter;
extern int setting_cv_bf_d;
extern int setting_cv_bf_sc;
extern int setting_cv_bf_ss;

extern bool setting_opt_vkf;
extern bool rgbd_flag;

extern bool dense_tracking_with_dense_depth_only;

extern std::string setting_tracking_type;
extern std::string setting_tracking_device;
extern int setting_tracking_step;

extern int dr_mvsnet_view_num;

extern bool dr_timing;

extern bool exit_when_done;
extern bool save_depth_maps;

extern bool use_int_sorting;

extern int frame_save_index;

extern int pangolin_layout;
extern bool pangolin_fullscreen;
extern bool pangolin_mesh ;
extern bool pangolin_reduced_images;

extern int mesh_extraction_freq;

extern bool save_coarse_tracker;

extern bool tandem_demo_mvsnet_return_early;
}
