...
bool setting_render_displayDenseDepth = false;
bool setting_render_displaySparseDepth = true;
...
std::string depth_save_folder = "";
std::string depth_var_save_folder = "";
bool debugSaveDepthImages = false;

std::string mvsnet_folder = "";
bool mvsnet_flag = false;
float mvsnet_discard_percentage = 10.0;
bool setting_tsdf_fusion = false;

bool setting_use_bilateral_filter = false;
int setting_cv_bf_d = 7;
int setting_cv_bf_sc = 1;
int setting_cv_bf_ss = 1;
bool setting_opt_vkf = false;
bool rgbd_flag = false;
bool dense_tracking_with_dense_depth_only = false;
std::string setting_tracking_type = "sparse";
std::string setting_tracking_device = "cpu";
int setting_tracking_step = 1;


int dr_mvsnet_view_num = 7;

bool dr_timing = false;

bool exit_when_done = false;
bool save_depth_maps = false;

bool use_int_sorting = false;

int frame_save_index = -1;

int pangolin_layout = 0;
bool pangolin_fullscreen = false;
bool pangolin_mesh = false;
bool pangolin_reduced_images = true;

int mesh_extraction_freq = 10;

bool save_coarse_tracker = false;

bool tandem_demo_mvsnet_return_early = true;
}
