...
#ifdef __AVX__
template<int simd_size=8>
class AVXAccumulator9{
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
  ...
  inline void initialize()
  {
    H.setZero();
    b.setZero();
    memset(SSEData,0, sizeof(float) * simd_size * 45);
    memset(SSEData1k,0, sizeof(float) * simd_size * 45);
    memset(SSEData1m,0, sizeof(float) * simd_size * 45);
    num = numIn1 = numIn1k = numIn1m = 0;
  }
  ...
  inline void finish()
  {
    ...
    for(int r=0;r<9;r++)
      ...
      {
        float d = 0.0f;
        for (int simde_idx = 0; simde_idx < simd_size; simde_idx++)
          d += SSEData1m[idx+simde_idx];
        H(r,c) = H(c,r) = d;
        idx+=simd_size;
      }
    assert(idx == simd_size * 45);
  }

  inline void updateSSE_eighted(
      const __m256 J0,const __m256 J1,
      const __m256 J2,const __m256 J3,
      const __m256 J4,const __m256 J5,
      const __m256 J6,const __m256 J7,
      const __m256 J8, const __m256 w)
  {
    float* pt=SSEData;

    __m256 J0w = _mm256_mul_ps(J0, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J0, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J1, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J2, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J3, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J4, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J0w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J1w = _mm256_mul_ps(J1, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J1, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J2, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J3, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J4, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J1w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J2w = _mm256_mul_ps(J2, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J2, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J3, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J4, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J2w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J3w = _mm256_mul_ps(J3, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J3, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J4, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J3w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J4w = _mm256_mul_ps(J4, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J4w, J4, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J4w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J4w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J4w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J4w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J5w = _mm256_mul_ps(J5, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J5w, J5, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J5w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J5w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J5w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J6w = _mm256_mul_ps(J6, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J6w, J6, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J6w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J6w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J7w = _mm256_mul_ps(J7, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J7w, J7, _mm256_load_ps(pt)));  pt+=8;
    _mm256_store_ps(pt, _mm256_fmadd_ps(J7w, J8, _mm256_load_ps(pt)));  pt+=8;

    __m256 J8w = _mm256_mul_ps(J8, w);
    _mm256_store_ps(pt, _mm256_fmadd_ps(J8w, J8, _mm256_load_ps(pt)));
...
private:
  EIGEN_ALIGN64 float SSEData[simd_size * 45];
  EIGEN_ALIGN64 float SSEData1k[simd_size * 45];
  EIGEN_ALIGN64 float SSEData1m[simd_size * 45];
  float numIn1, numIn1k, numIn1m;
  ...
  void shiftUp(bool force)
  {
    ...
    {
      for(int i=0;i<45;i++)
        _mm256_store_ps(SSEData1k + simd_size * i, _mm256_add_ps(_mm256_load_ps(SSEData + simd_size * i), _mm256_load_ps(SSEData1k + simd_size * i)));
      numIn1k+=numIn1;
      numIn1=0;
      memset(SSEData,0, sizeof(float) * simd_size * 45);
    }
    ...
    {
      for(int i=0;i<45;i++)
        _mm256_store_ps(SSEData1m + simd_size * i, _mm256_add_ps(_mm256_load_ps(SSEData1k + simd_size * i), _mm256_load_ps(SSEData1m + simd_size * i)));
      numIn1m+=numIn1k;
      numIn1k=0;
      memset(SSEData1k,0, sizeof(float) * simd_size * 45);
    }
